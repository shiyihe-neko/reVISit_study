...
export interface ColorTextResponseD extends BaseResponse {
  type: 'colorTextD';
  /** The placeholder text that is displayed in the input. */
  placeholder?: string;
}
...
export type Response = NumericalResponse | ShortTextResponse | LongTextResponse | ColorTextResponse | ColorTextResponseD | LikertResponse | DropdownResponse | SliderResponse | RadioResponse | CheckboxResponse | RankingResponse | ReactiveResponse | MatrixResponse | ButtonsResponse | TextOnlyResponse | DividerResponse;
